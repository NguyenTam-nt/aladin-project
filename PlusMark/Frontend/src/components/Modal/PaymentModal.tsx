...
function PaymentModal() {
  ...
  return (
    <div className='flex max-w-[90%] flex-col justify-center items-center bg-white rounded-lg shadow-md py-7'>
        ...
        <p className='text-center text-normal2 lg:text-title font-bold text-[#00880C] px-4 lg:px-16 my-2 lg:my-4'>{t("payment.success_modal.title")}</p>
        <p className=' text-wap-regular2 lg:text-normal font-medium  px-4 lg:px-16 flex items-center'>{t("payment.success_modal.thank")} <LogoSupershopIcon /></p>
