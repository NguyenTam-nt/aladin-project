...
export const GotoTop = () => {
  ...
  return (
    <button
      ...
      className="w-[40px] h-[40px] 2xl:w-[54px] fixed bottom-[20%] z-[10] right-0 hidden items-center justify-center 2xl:h-[54px] rounded-[8px_0_8px_0px] 2xl:rounded-[16px_0_16px_0] bg-text_A1A0A3"
    >
