    ...
    <div className="h-[32px] xl:h-[48px] bg-bg_A7E8ED relative">
      ...
      <div className="w-rp flex h-full justify-between items-center relative  z-[1]">
        <div className="flex items-center">
          <div>
            <Logo1 width={width < withResponsive._1280 ? 23 : 35 } height={width < withResponsive._1280 ? 16 : 24} />
          </div>
          <div className=" ml-[4px] mr-[8px] xl:ml-[8px] xl:mr-[32px]">
            <Logo2 width={width < withResponsive._1280 && 49 } height={width < withResponsive._1280 && 11} />
          </div>
          <div>
            <Logo3 width={width < withResponsive._1280 && 86 } height={width < withResponsive._1280 && 16} />
          </div>
        </div>
