...
export const HomeTopicSalesItem = memo(({index}:Props) => {
  return (
    <div className="rounded-[32px_0_32px_0] flex items-end relative overflow-hidden h-[426px] p-[24px]">
      ...
      <div className="flex w-full flex-col justify-center relative text-text_white z-[3] items-center">
        <div className="flex items-center">
          <span className="text-_18 font-bold">{formatNumberDot(600000)}</span>
