...
export const TopicPlaceItem = () => {
  ...
  return (
    <div className="grid grid-cols-3 gap-x-[24px] mt-[48px] ">
...
export const TopicPlaceItemBase = () => {
  return (
    <div className="flex-1 px-[24px] overflow-y-auto list-facilities">
      {data.map((item, index) => {
        return (
          <div key={index} className="py-[16px] border-b border-br_E6E6E6">
