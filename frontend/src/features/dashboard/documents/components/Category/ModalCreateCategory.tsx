  ...
  return (
    <div className=" w-[800px] 2xl:w-[1144px] bg-white py-[40px] px-[24px]">
      <TitleForm
        title={
          type === "ADD"
            ? "admin.docmunents._category._form.title_add"
            : "admin.docmunents._category._form.title_edit"
        }
      />
      <div className="grid grid-cols-1 gap-[24px]">
        <div>
          <TitleInput
            forId="admin.docmunents._category._form.name_parent"
            name="admin.docmunents._category._form.name_parent"
          />
          <Input
            id="admin.docmunents._category._form.name_parent"
            placeholder="admin.docmunents._category._form.name_parent_placeholder"
          />
        </div>
        <div>
          <TitleInput
            forId="admin.docmunents._category._form.name_child"
            name="admin.docmunents._category._form.name_child"
          />
        ...
        <div>
          <Button
            ...
            text="admin.docmunents._category._form.btn_create"
          ...
          return (
            <div key={index} className="flex items-center gap-x-[24px] w-full">
              <div className="flex-1">
                <Input
                  id="admin.docmunents._category._form.name_child"
                  placeholder="admin.docmunents._category._form.name_child_placeholder"
                />
              </div>
