...
export const CommentItem = memo(({ data, onDelete, onEdit }: Props) => {
  ...
  const handleShowModalDelete = () => {
    setElementModal(
      <DiglogComfirmDelete onClick={handleDelete} message="adminComment.message_delete" />
    );
  };
    ...
    <div className="bg-white mb-4">
      ...
      <div className="grid grid-cols-3 [&>div]:p-[16px]">
        ...
        <div className="border-r border-br_E8E8E8">
          <div className="flex items-center gap-x-4">{renderStar( Number(data?.commentGuest?.rate), 24)}</div>
