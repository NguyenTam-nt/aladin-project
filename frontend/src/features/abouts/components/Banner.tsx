  ...
  return (
    <div className=" relative">
      ...
      <div className=" absolute inset-0 z-[4] flex flex-col justify-center items-center text-text_white">
        <Button onClick={goToTrain} color="primary" text="button._train" className="!w-[78px] flex justify-center bg-secondary !h-[28px] !py-[2px] !text-_12" />
        ...
        >Adipiscing tortor donec massa eget duis libero tortor donec venenatis et.</h3>
