...
function AboutUsItem({item, idx}: Props) {
  ...
  return (
    <div className='w-rp mb-6 hover:cursor-pointer'>
      ...
      >
        <h4 className='flex justify-center items-center h-6 lg:h-auto text-secondary text-_14 lg:text-_18 uppercase font-bold line-clamp-2'>{item.name} - {item.address}</h4>
        <div className="">
