...
import {defaultAvatar, defaultImage} from 'src/assets/image';
...
export const ThumbFallback: React.FC<ThumbFallbackProps> = (props: any) => {
  if (props.bannerType) {
    return <FastImage {...props} source={defaultImage} resizeMode="cover" />;
  }
  if (props.avatarType) {
    return <FastImage {...props} source={defaultAvatar} resizeMode="cover" />;
  }
  return <FastImage {...props} source={defaultImage} resizeMode="cover" />;
};
