...
// export const checkNotificationPermission: () => IReturnRequestPermission =
//   async () => {
...
//     requestPhotoLibraryPermissions(onSuccess, () =>
//       onNotAllowedAccessPhotosLibrary(permisstionText.image),
//     );
//   },
//   handleSelectCamera: (onSuccess: () => void) => {
//     requestCameraPermissions(onSuccess, () =>
//       onNotAllowedAccessPhotosLibrary(permisstionText.camera),
//     );
//   },
//   handleSelectFiles: (onSuccess: () => void) => {
//     requestStorgePermissions(onSuccess, () =>
//       onNotAllowedAccessPhotosLibrary(permisstionText.files),
//     );
//   },
// };
