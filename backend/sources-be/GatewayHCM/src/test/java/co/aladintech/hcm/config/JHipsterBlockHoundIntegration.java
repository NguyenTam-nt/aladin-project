...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("co.aladintech.hcm.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("co.aladintech.hcm.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
