...
describe('Cadres Management Component', () => {
  let comp: CadresComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'cadres', component: CadresComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(CadresComponent, '')
      .compileComponents();
  ...
  describe('trackId', () => {
    it('Should forward to cadresService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCadresIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCadresIdentifier).toHaveBeenCalledWith(entity);
