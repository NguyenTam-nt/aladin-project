...
type SubjectFormGroupContent = {
  ...
  nameKo: FormControl<ISubject['nameKo']>;
  description: FormControl<ISubject['description']>;
  descriptionKo: FormControl<ISubject['descriptionKo']>;
  titleKo: FormControl<ISubject['titleKo']>;
  contentKo: FormControl<ISubject['contentKo']>;
};
...
export class SubjectFormService {
  createSubjectFormGroup(subject: SubjectFormGroupInput = { id: null }): SubjectFormGroup {
    ...
    return new FormGroup<SubjectFormGroupContent>({
      ...
      nameKo: new FormControl(subjectRawValue.nameKo, {
        validators: [Validators.required],
      }),
      description: new FormControl(subjectRawValue.description, {
        validators: [Validators.required],
      }),
      descriptionKo: new FormControl(subjectRawValue.descriptionKo, {
        validators: [Validators.required],
      }),
      titleKo: new FormControl(subjectRawValue.titleKo, {
        validators: [Validators.required],
      }),
      contentKo: new FormControl(subjectRawValue.contentKo, {
        validators: [Validators.required],
      }),
    });
  }
