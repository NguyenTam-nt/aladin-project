...
public class SubjectResource {
    ...
    private static final String ENTITY_NAME = "backendHcmSubject";
     ...
     */
    @GetMapping("/subjects")
    public ResponseEntity<List<SubjectDTO>> getAllSubjects(@RequestParam(required = false) String keyword, @org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of Subjects");
        Page<SubjectDTO> page = subjectService.findAll(keyword, pageable);
    ...
    @DeleteMapping("/subjects/allid")
    public ResponseEntity<Void> deleteSubjectAll(@RequestParam List<Long> ids) {
        log.debug("REST request to delete Subject : {}", ids);
